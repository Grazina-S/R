---
title: "naudingos funkcijos"
output: html_notebook
---

Funkcija suvartyti keleta stulpeliu is karto i factor.<br>
...
Funkcija paimti is HSD outputo statistika ir grupes<br>
...
```
Jaccard index for binary data.<br>
...
```
Kaip gauti Jaccard indeksu lentele.<br>df yra duomenu failas
